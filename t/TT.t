...
ok( @difflines == 0, "orig text matches distributed corpus text");
...
ok( $wc_orig eq $wc_uc, "orig corpus wc matches capitalized corpus wc");
...
for $corp ( qw{ odyssey odyssey_wc odyssey_uc odyssey_lines } ){
  ...
  ok(!-e "corpora/$corp", "test corpus $corp deleted");
}
